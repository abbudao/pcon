...
printf("Before first bcast");
  /*Receive matrix order from Master*/
  MPI_Bcast(&col_size,1,MPI_INT,0,inter_comm);
  /*Receive number of columns from Master */
  MPI_Scatter(NULL,0,MPI_INT,&col_count,1,MPI_INT,0,inter_comm);
  ...
  MPI_Scatterv(NULL,NULL,NULL,MPI_INT,cols,col_count,MPI_FLOAT,0,inter_comm);
